<h1>Desafio projeto Mario Kart.JS</h1>
  ...
  <table>
        <tr>
            ...
            <td>
                <b>Objetivo:</b>
                <p>Mario Kart é uma série de jogos de corrida desenvolvida e publicada pela Nintendo. Essa prática foi feita para a realização de uma atividade do curso DIO onde o desafio foi criar uma lógica de um jogo de vídeo game para simular corridas de Mario Kart, levando em consideração as regras e mecânicas abaixo.</p>
            </td>
        </tr>
    </table>
